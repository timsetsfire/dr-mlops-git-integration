...
USERNAME = "timothy.whittaker+mlops-demo@datarobot.com"

# DEPLOYMENT_ID = '5eb5917c5aabb409a6697978'
DEPLOYMENT_ID = "5ebaca724414d70873d1e477"
...
def make_datarobot_deployment_predictions(data, deployment_id):
    ...
    url = (
        "https://cfds-ccm-prod.orm.datarobot.com/predApi/v1.0/deployments/{deployment_id}/"
        "predictionExplanations".format(deployment_id=deployment_id)
    )
    ...
    predictions_response = requests.post(
        url, auth=(USERNAME, API_KEY), data=data, headers=headers, params=params,
    )
